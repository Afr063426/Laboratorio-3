...
precioC<-function(K,S_0,n,hn,volatilidad,r,q,t,d){
  ...
  sum(choose(n,c(parametros[1]:n))*parametros[2]^(c(parametros[1]:n))*(1-parametros[2])^(n-c(parametros[1]:n))*parametros[3]^(c(parametros[1]:n))*(1/parametros[3])^(n-(c(parametros[1]:n)))*S_0-K)*exp(-t*r) ### Formula para precio de de las opciones de compra
}
