...
rendimiento<-log((Montos$DiviendoPorAcción[5]+Montos$DiviendoPorAcción[4])/Promedio+1)
...
tasasBCCR%>%kbl(caption="<center><strong> Tabla 5: <strong>Tasas de Rendimiento, Curva Soberana</center>")%>%kable_material()%>%kable_styling(full_width = F)
...
q<-rendimiento ## A la espera de dividendos anuales
