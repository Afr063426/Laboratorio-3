...
### Se procede a programar la forma en que se calculan los precios de las opciones
...
\[
C=\sum_{i=0}^{n}\left(\frac{n!}{i!(n-j)!}p^{i}(1-p)^{n-i}\max\{0,u^jd^{n-j}S_0-K\}\right)
\]
...
\[
C=\sum_{i=a}^{n}\left(\frac{n!}{i!(n-j)!}p^{i}(1-p)^{n-i}u^jd^{n-j}S_0-K\}\right)
\]
