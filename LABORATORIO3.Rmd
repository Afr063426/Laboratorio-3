...
Las opciones de compra y venta de activos financieros son instrumentos utilizados alrededor del mundo por inversionistas que buscan incrementar su riqueza o cubrirse del riesgo.  Así que en el presente trabajo se va a exponer el modelo de Cox, Ross y Rubinstein (1979), mismo que se aplicará sobre el activo denominado acciones de Holcim Costa Rica, para obtener el resultado de las opciones.
...
También se abarcará una sección metodológica y de análisis de los datos implementados. En esta última se llevará acabado una presentación de los datos y características importantes de los mismos. Por su parte se dedicará una sección al análisis del árbol y su implementación, para clarificar el proceso seguido para su obtención.
