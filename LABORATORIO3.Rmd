...
Las opciones de compra y venta de activos financieros son instrumentos utilizados alrededor del mundo por inversionistas que buscan incrementar su riqueza.  Así que en el presente trabajo se va a exponer el modelo de Cox, Ross y Rubinstein (1979), mismo que se aplicará sobre el activo denominado precio de las acciones de Holcim Costa Rica, para obtener el resultado de las opciones.
