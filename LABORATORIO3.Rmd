...
```{tikz, fig.cap = "Figura 1: Árbol Binomial de Dos Pasos", fig.ext = 'png'}
...
Es importante tener presentes algunos aspectos estadísticos que posteriormente serán útiles al momento de hablar del árbol binomial, por lo que primeramente se presentan un par de definiciones.
