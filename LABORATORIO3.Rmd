...
Además, se infiere que las opciones de compra y venta de las acciones analizadas son relativamente bajas, esto debido a que en el año estudiado la volatilidad y los rendimientos fueron relativamente bajos. Lo anterior repercute directamente en la probabilidad de que el valor de la acción suba o baje, y esto mismo incide en el cálculo de las opciones. Por ende, se concluye también que existe una relación positiva entre la volatilidad y probabilidad de variación los activos financieros con los valores de las opciones de compra y venta de estos.
