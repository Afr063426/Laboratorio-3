...
```
A los anteriores datos se les aplico, según la 
...
tasasBCCR<-tasasBCCR[1:(ncol(tasasBCCR)-1)]
...
```{r}
  ...
  labs(y = "Rendimientos",x = "Fecha de maduración" ,caption = "Fuente: Elaboración propia, con datos del ....")+theme_minimal()+theme(legend.position="bottom",plot.caption=element_text(hjust=0))
```
